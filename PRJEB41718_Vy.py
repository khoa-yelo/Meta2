...
df_final =  df_curated[df_curated['Study_ID'] == "PRJEB41718"]
...
sample_accession_age_map = df_sra[df_sra['bioproject'] == "PRJEB6070"][["sample_accession","age_years"]].set_index("sample_accession").to_dict()["age_years"] 
...
df_final.to_csv("/content/drive/Shareddrives/Meta2/Metadata/Final_Curated_Out/PRJEB41718_Vy.csv", index = None)
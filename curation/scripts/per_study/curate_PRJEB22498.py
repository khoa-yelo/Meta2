...
df_curated_PRJEB22498=  df_curated[df_curated['Study_ID'] == "PRJEB22498"]
df_original_subject = df_original[df_original["study_bioproject"] == "PRJEB22498"][["sample_accession", "sample_sample-name"]]
df_sra_subject = df_sra[df_sra['bioproject'] == "PRJEB6092"]
...
df_curated_PRJEB22498["Subject_ID"] = df_curated_PRJEB22498["Sample_accession"].map(sample_accession_subject_map)
df_curated_PRJEB22498["Nucleotide_Type"] = df_curated_PRJEB22498["Sample_accession"].map(sample_accession_nucleotide_map)
df_curated_PRJEB22498["Body_site"] = "gut"
df_curated_PRJEB22498["Body_site_core"] = "gut"
df_curated_PRJEB22498["Nucleotide_Type"] = "DNA"
df_curated_PRJEB22498["Location"] = "Australia"

df_curated_PRJEB22498.to_csv("/content/drive/Shareddrives/Meta2/Metadata/Final_Curated_Out/PRJEB22498.csv", index = None)

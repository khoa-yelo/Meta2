...
df_curated_PRJEB75578 = df_curated[df_curated['Study_ID'] == "PRJEB75578"]
df_original_subject = df_original[df_original["study_bioproject"] == "PRJEB75578"][["sample_accession", "sample_sample-name","sample_sample-desc","sample_biosample"]]
df_sra_subject = df_sra[df_sra['bioproject'] == "PRJNA664754"]
...
df_curated_PRJEB75578["Subject_ID"] = df_curated_PRJEB75578["Sample_accession"].map(sample_accession_subject_map)
df_curated_PRJEB75578["Nucleotide_Type"] = df_curated_PRJEB75578["Sample_accession"].map(sample_accession_nucleotide_map)
df_curated_PRJEB75578["Body_site"] = "gut"
df_curated_PRJEB75578["Body_site_core"] = "gut"
#df_curated_PRJEB53689["Nucleotide_Type"] = "DNA"
df_curated_PRJEB75578["Age"] = df_curated_PRJEB75578["Sample_accession"].map(sample_accession_age_map)
df_curated_PRJEB75578["Sex"] = df_curated_PRJEB75578["Sample_accession"].map(sample_accession_sex_map)
df_curated_PRJEB75578["Health_status"] = df_curated_PRJEB75578["Sample_accession"].map(sample_accession_health_map)
df_curated_PRJEB75578["Location"] = df_curated_PRJEB75578["Sample_accession"].map(sample_accession_location_map)
df_curated_PRJEB75578["Diet"] = "5-day course of one of the following antibiotics: AZM, LVX, CPD, or CPD + AZM"

df_curated_PRJEB75578.to_csv("/content/drive/Shareddrives/Meta2/Metadata/Final_Curated_Out/PRJEB75578.csv", index = None)

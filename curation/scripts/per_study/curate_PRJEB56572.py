...
df_curated_PRJEB56572 = df_curated[df_curated['Study_ID'] == "PRJEB56572"]
df_original_subject = df_original[df_original["study_bioproject"] == "PRJEB56572"][["sample_accession", "sample_sample-name","sample_sample-desc","sample_biosample"]]
df_sra_subject = df_sra[df_sra['bioproject'] == "PRJNA791464"]
...
df_curated_PRJEB56572["Subject_ID"] = df_curated_PRJEB56572["Sample_accession"].map(sample_accession_subject_map)
df_curated_PRJEB56572["Nucleotide_Type"] = df_curated_PRJEB56572["Sample_accession"].map(sample_accession_nucleotide_map)
df_curated_PRJEB56572["Body_site"] = "oral"
df_curated_PRJEB56572["Body_site_core"] = "oral"
#df_curated_PRJEB53689["Nucleotide_Type"] = "DNA"
df_curated_PRJEB56572["Age"] = df_curated_PRJEB56572["Sample_accession"].map(sample_accession_age_map)
df_curated_PRJEB56572["Sex"] = df_curated_PRJEB56572["Sample_accession"].map(sample_accession_sex_map)
df_curated_PRJEB56572["Health_status"] = df_curated_PRJEB56572["Sample_accession"].map(sample_accession_health_map)
df_curated_PRJEB56572["Location"] = df_curated_PRJEB56572["Sample_accession"].map(sample_accession_location_map)
df_curated_PRJEB56572["Age_group"] = "Child"cological regulators within the recent three months"

df_curated_PRJEB56572.to_csv("/content/drive/Shareddrives/Meta2/Metadata/Final_Curated_Out/PRJEB56572.csv", index = None)

...
df_curated_PRJEB26165 = df_curated[df_curated['Study_ID'] == "PRJEB26165"]
df_original_subject = df_original[df_original["study_bioproject"] == "PRJEB26165"][["sample_accession", "sample_sample-name","sample_sample-desc","sample_biosample"]]
df_sra_subject = df_sra[df_sra['bioproject'] == "PRJNA240307"]
...
df_sra[df_sra['bioproject'] == "PRJNA240307"] #use study_ID_original here

df_curated_PRJEB26165["Subject_ID"] = df_curated_PRJEB26165["Sample_accession"].map(sample_accession_subject_map)
df_curated_PRJEB26165["Nucleotide_Type"] = df_curated_PRJEB26165["Sample_accession"].map(sample_accession_nucleotide_map)
df_curated_PRJEB26165["Body_site"] = "gut"
df_curated_PRJEB26165["Body_site_core"] = "gut"
#df_curated_PRJEB53689["Nucleotide_Type"] = "DNA"
df_curated_PRJEB26165["Age"] = df_curated_PRJEB26165["Sample_accession"].map(sample_accession_age_map)
df_curated_PRJEB26165["Sex"] = df_curated_PRJEB26165["Sample_accession"].map(sample_accession_sex_map)
df_curated_PRJEB26165["Health_status"] = df_curated_PRJEB26165["Sample_accession"].map(sample_accession_health_map)
df_curated_PRJEB26165["Location"] = df_curated_PRJEB26165['Sample_accession'].map(sample_accession_location_map)



df_curated_PRJEB26165.to_csv("/content/drive/Shareddrives/Meta2/Metadata/Final_Curated_Out/PRJEB26165.csv", index = None)

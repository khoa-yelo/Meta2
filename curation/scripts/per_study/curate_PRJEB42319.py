...
df_curated_PRJEB42319=  df_curated[df_curated['Study_ID'] == "PRJEB42319"]
df_original_subject = df_original[df_original["study_bioproject"] == "PRJEB42319"][["sample_accession", "sample_sample-name"]]
df_sra_subject = df_sra[df_sra['bioproject'] == "PRJDB4115"]
...
df_curated_PRJEB42319["Subject_ID"] = df_curated_PRJEB42319["Sample_accession"].map(sample_accession_subject_map)
df_curated_PRJEB42319["Nucleotide_Type"] = df_curated_PRJEB42319["Sample_accession"].map(sample_accession_nucleotide_map)
df_curated_PRJEB42319["Body_site"] = "gut"
df_curated_PRJEB42319["Body_site_core"] = "gut"
df_curated_PRJEB42319["Nucleotide_Type"] = "DNA"
df_curated_PRJEB42319["Health_status"] = "Healthy"

df_curated_PRJEB42319.to_csv("/content/drive/Shareddrives/Meta2/Metadata/Final_Curated_Out/PRJEB42319.csv", index = None)

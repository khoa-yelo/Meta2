...
df_curated_PRJEB56742 =  df_curated[df_curated['Study_ID'] == "PRJEB56742"]
df_original_subject = df_original[df_original["study_bioproject"] == "PRJEB56742"][["sample_accession", "sample_sample-name"]]
df_sra_subject = df_sra[df_sra['bioproject'] == "PRJNA757683"]
...
df_curated_PRJEB56742["Subject_ID"] = df_curated_PRJEB56742["Sample_accession"].map(sample_accession_subject_map)
df_curated_PRJEB56742["Nucleotide_Type"] = df_curated_PRJEB56742["Sample_accession"].map(sample_accession_nucleotide_map)
df_curated_PRJEB56742["Location"] = "USA"
df_curated_PRJEB56742["Body_site"] = "oral"
df_curated_PRJEB56742["Body_site_core"] = "oral"
df_curated_PRJEB56742["Nucleotide_Type"] = "DNA"

df_curated_PRJEB56742.to_csv("/content/drive/Shareddrives/Meta2/Metadata/Final_Curated_Out/PRJEB56742.csv", index = None)

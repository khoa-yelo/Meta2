...
df_curated_PRJEB41181=  df_curated[df_curated['Study_ID'] == "PRJEB41181"]
df_original_subject = df_original[df_original["study_bioproject"] == "PRJEB41181"][["sample_accession", "sample_sample-name"]]
df_sra_subject = df_sra[df_sra['bioproject'] == "PRJEB19090"]
...
df_curated_PRJEB41181["Subject_ID"] = df_curated_PRJEB41181["Sample_accession"].map(sample_accession_subject_map)
df_curated_PRJEB41181["Nucleotide_Type"] = df_curated_PRJEB41181["Sample_accession"].map(sample_accession_nucleotide_map)
df_curated_PRJEB41181["Body_site"] = "gut"
df_curated_PRJEB41181["Body_site_core"] = "gut"
df_curated_PRJEB41181["Nucleotide_Type"] = "DNA"
df_curated_PRJEB41181["Location"] = "Italy"
df_curated_PRJEB41181["Health_status"] = "Healthy"

df_curated_PRJEB41181.to_csv("/content/drive/Shareddrives/Meta2/Metadata/Final_Curated_Out/PRJEB41181.csv", index = None)

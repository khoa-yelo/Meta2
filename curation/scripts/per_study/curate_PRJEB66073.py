...
df_original_subject = df_original[df_original["study_bioproject"] == "PRJEB66073"][["sample_accession", "sample_sample-name"]]
...
sample_accession_nucleotide_map = df_sra[df_sra['bioproject'] == "PRJEB66073"][["sample_accession", "nucleotide_type"]].set_index("sample_accession").to_dict()["nucleotide_type"]
...
df_curated_PRJEB66073["Location"] = "USA"
df_curated_PRJEB66073["Body_site"] = "oral"
df_curated_PRJEB66073["Body_site_core"] = "saliva"
df_curated_PRJEB66073["Nucleotide_Type"] = "DNA"

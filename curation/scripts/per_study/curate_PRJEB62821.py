...
df_curated_PRJEB62821=  df_curated[df_curated['Study_ID'] == "PRJEB62821"]
df_original_subject = df_original[df_original["study_bioproject"] == "PRJEB62821"][["sample_accession", "sample_sample-name"]]
df_sra_subject = df_sra[df_sra['bioproject'] == "PRJEB52094"]
...
df_curated_PRJEB62821["Subject_ID"] = df_curated_PRJEB62821["Sample_accession"].map(sample_accession_subject_map)
df_curated_PRJEB62821["Nucleotide_Type"] = df_curated_PRJEB62821["Sample_accession"].map(sample_accession_nucleotide_map)
df_curated_PRJEB62821["Body_site"] = "gut"
df_curated_PRJEB62821["Body_site_core"] = "gut"
df_curated_PRJEB62821["Nucleotide_Type"] = "DNA"

df_curated_PRJEB62821.to_csv("/content/drive/Shareddrives/Meta2/Metadata/Final_Curated_Out/PRJEB62821.csv", index = None)

...
df_sra_subject['nucleotide_type'].unique()
df_sra_subject['geo_location'].unique()

df_curated_PRJEB65351["Subject_ID"] = df_curated_PRJEB65351["Sample_accession"].map(sample_accession_subject_map)
df_curated_PRJEB65351["Nucleotide_Type"] = df_curated_PRJEB65351["Sample_accession"].map(sample_accession_nucleotide_map)
df_curated_PRJEB65351["Body_site"] = "oral"
df_curated_PRJEB65351["Body_site_core"] = "oral"
df_curated_PRJEB65351["Nucleotide_Type"] = "DNA"
df_curated_PRJEB65351["Age"] = df_curated_PRJEB65351["Sample_accession"].map(sample_accession_age_map)

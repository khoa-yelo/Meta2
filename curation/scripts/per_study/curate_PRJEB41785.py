...
df_curated_PRJEB41785["Subject_ID"] = df_curated_PRJEB41785["Sample_accession"].map(sample_accession_subject_map)
df_curated_PRJEB41785["Nucleotide_Type"] = df_curated_PRJEB41785["Sample_accession"].map(sample_accession_nucleotide_map)
df_curated_PRJEB41785["Body_site"] = "gut"
df_curated_PRJEB41785["Body_site_core"] = "gut"
#df_curated_PRJEB53689["Nucleotide_Type"] = "DNA"
df_curated_PRJEB41785["Age"] = df_curated_PRJEB41785["Sample_accession"].map(sample_accession_age_map)
df_curated_PRJEB41785["Sex"] = df_curated_PRJEB41785["Sample_accession"].map(sample_accession_sex_map)
df_curated_PRJEB41785["Health_status"] = df_curated_PRJEB41785["Sample_accession"].map(sample_accession_health_map)
df_curated_PRJEB41785["Location"] = df_curated_PRJEB41785["Sample_accession"].map(sample_accession_location_map)

df_curated_PRJEB41785 = df_curated[df_curated['Study_ID'] == "PRJEB41785"]
df_original_subject = df_original[df_original["study_bioproject"] == "PRJEB41785"][["sample_accession", "sample_sample-name","sample_sample-desc","sample_biosample"]]
df_sra_subject = df_sra[df_sra['bioproject'] == "PRJNA628604"]
...
df_curated_PRJEB41785.to_csv("/content/drive/Shareddrives/Meta2/Metadata/Final_Curated_Out/PRJEB41785.csv", index = None)

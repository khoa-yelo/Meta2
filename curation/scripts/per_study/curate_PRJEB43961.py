...
df_curated_PRJEB43961=  df_curated[df_curated['Study_ID'] == "PRJEB43961"]
df_original_subject = df_original[df_original["study_bioproject"] == "PRJEB43961"][["sample_accession", "sample_sample-name"]]
df_sra_subject = df_sra[df_sra['bioproject'] == "PRJEB1690"]
...
df_curated_PRJEB43961["Subject_ID"] = df_curated_PRJEB43961["Sample_accession"].map(sample_accession_subject_map)
df_curated_PRJEB43961["Nucleotide_Type"] = df_curated_PRJEB43961["Sample_accession"].map(sample_accession_nucleotide_map)
df_curated_PRJEB43961["Body_site"] = "gut"
df_curated_PRJEB43961["Body_site_core"] = "gut"
df_curated_PRJEB43961["Nucleotide_Type"] = "DNA"
df_curated_PRJEB43961["Location"] = "Korea"

df_curated_PRJEB43961.to_csv("/content/drive/Shareddrives/Meta2/Metadata/Final_Curated_Out/PRJEB43961.csv", index = None)

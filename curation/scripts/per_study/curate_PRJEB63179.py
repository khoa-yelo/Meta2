...
df_original_subject = df_original[df_original["study_bioproject"] == "PRJEB63179"][["sample_accession", "sample_sample-name","sample_sample-desc","sample_biosample"]]
...
df_curated_PRJEB63179["Age"] = df_curated_PRJEB63179["Sample_accession"].map(sample_accession_age_map)
df_curated_PRJEB63179["Sex"] = df_curated_PRJEB63179["Sample_accession"].map(sample_accession_sex_map)
df_curated_PRJEB63179["Health_status"] = df_curated_PRJEB63179["Sample_accession"].map(sample_accession_health_map)
df_curated_PRJEB63179["Location"] = df_curated_PRJEB63179['Sample_accession'].map(sample_accession_location_map)

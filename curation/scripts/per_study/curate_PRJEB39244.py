...
df_curated_PRJEB39244 = df_curated[df_curated['Study_ID'] == "PRJEB39244"]
df_original_subject = df_original[df_original["study_bioproject"] == "PRJEB39244"][["sample_accession", "sample_sample-name","sample_sample-desc","sample_biosample"]]
df_sra_subject = df_sra[df_sra['bioproject'] == "PRJEB11511"]
...
df_curated_PRJEB39244["Subject_ID"] = df_curated_PRJEB39244["Sample_accession"].map(sample_accession_subject_map)
df_curated_PRJEB39244["Nucleotide_Type"] = df_curated_PRJEB39244["Sample_accession"].map(sample_accession_nucleotide_map)
df_curated_PRJEB39244["Body_site"] = "gut"
df_curated_PRJEB39244["Body_site_core"] = "gut"
#df_curated_PRJEB53689["Nucleotide_Type"] = "DNA"
df_curated_PRJEB39244["Age"] = df_curated_PRJEB39244["Sample_accession"].map(sample_accession_age_map)
df_curated_PRJEB39244["Sex"] = df_curated_PRJEB39244["Sample_accession"].map(sample_accession_sex_map)
df_curated_PRJEB39244["Health_status"] = df_curated_PRJEB39244["Sample_accession"].map(sample_accession_health_map)
df_curated_PRJEB39244["Location"] = df_curated_PRJEB39244["Sample_accession"].map(sample_accession_location_map)

df_curated_PRJEB39244.to_csv("/content/drive/Shareddrives/Meta2/Metadata/Final_Curated_Out/PRJEB39244.csv", index = None)
